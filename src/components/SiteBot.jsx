...
function SiteBot() {
  ...
  const [messages, setMessages] = useState([
    {
      role: "bot",
      text: "Hi 👋 I’m Samir AI. Ask me about articles, roadmaps, AI, science, space, technology, projects, or hiring Samir.",
    },
  ]);
...
try {
      ...
      console.error("SiteBot Error:", error);
      setMessages((prev) => [
        ...prev,
        {
          role: "bot",
          text: "Sorry, the assistant is temporarily unavailable. You can still explore the articles, roadmaps, or contact Samir directly.",
        },
      ]);
    } finally {
      setLoading(false);
      ...
      {open && (
        ...
        >
          ...
          <div className="sitebot-body" ref={bodyRef}>
            ...
            {showSuggestions && (
              <div className="sitebot-suggestions">
                <Link to="/stack" onClick={() => setOpen(false)}>
                  Roadmaps
                </Link>
          ...
          <div className="sitebot-footer">
            <input
              type="text"
              placeholder="Ask about articles, stacks, AI..."
              value={input}
