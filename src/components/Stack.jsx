...
function Stack() {
  ...
  const categories = useMemo(() => {
    return ["All", ...new Set(stacksData.map((stack) => stack.category))];
  }, []);
  ...
  const filteredStacks = useMemo(() => {
    ...
    return stacksData.filter((stack) => {
      const matchesSearch =
        ...
        stack.technologies?.some((tech) => tech.toLowerCase().includes(query));
        ...
        <div className="stack-container">
          ...
          <div className="stack-controls">
            <div className="stack-search">
              ...
              <input
                ...
                placeholder="Search stacks, tools, AI or careers..."
          ...
          {filteredStacks.length > 0 ? (
              ...
              {filteredStacks.map((stack) => (
                ...
                >
                  <div className="developer-card-header">
                    <div className="developer-stack-icon">{stack.icon}</div>
                    <span className="developer-stack-arrow">↗</span>
                  </div>
                  ...
                  <div className="stack-tech-list">
                    {stack.technologies?.slice(0, 3).map((technology) => (
                      <span key={technology}>{technology}</span>
                    ))}
                  </div>

                  <div className="developer-card-footer">
                    <span>{stack.roadmap?.length || 0} stages</span>
            ...
            <div className="stack-empty">
              ...
              <p>Try another career, technology, or category.</p>
